...
engine = create_engine("mysql+mysqlconnector://root:1234@localhost/moviebooking")
...
if movies.empty:
    st.warning('⚠️ No movies found in the database')
else:
    ...
    if movie_choice:
        ...
        if not shows.empty:
            ...
            if st.button('book now'):
                ...
                st.warning("⚠️ No shows available for this movie.")
