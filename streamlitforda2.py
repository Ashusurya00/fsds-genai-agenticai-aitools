...
information about families, including their income, expenses, education, occupation, and living conditions.  
*Dataset created by Ashutosh Suryawanshi.
""")


df = pd.read_csv(r'C:\Users\aashutosh\Downloads\Inc_Exp_Data.csv')
...
st.success(' Data Analysis of The Income & Expenditure Household Dataset Completed!')
